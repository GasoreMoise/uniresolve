...
import { Search, FileText, CheckCircle, Clock, AlertTriangle, RefreshCw, Eye, Loader2, LogOut, X, Filter, FolderOpen, ArrowLeft } from 'lucide-react';
...
export default function DepartmentalDashboardLedger() {
  ...
  // ◄ NEW: View management state for the drill-down category boxes
  ...
  // Reset category view if the user types a new search or changes the top-level filter to avoid empty states
  useEffect(() => {
  ...
  // 4. Group the final results cleanly by Service Name category
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className={`${inspectingTicket ? 'lg:col-span-7' : 'lg:col-span-12'} transition-all duration-300`}>
            ...
            {!selectedCategory ? (
              ...
              /* VIEW B: SELECTED CATEGORY TABLE */
